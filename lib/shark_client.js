...
function storagePath(opts) {
    ...
    var objectNameParts = utils.splitSubstr(objectName, OBJECT_NAME_PART_SIZE);
    var objectNamePath = objectNameParts.join('/');

    return (path.join('/', owner, bucketId, objectNamePath, objectId));
